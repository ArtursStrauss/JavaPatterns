package threadexamples.latency;
...
public class Main {
    ...
    public static void recolorPixel(BufferedImage originalImage, BufferedImage resultImage, int x, int y) {
        ...
        // System.out.println("rgb[int]: " + rgb + ", rgb[binary]: " + Integer.toBinaryString(rgb) + ", getRed{0x00FF0000}: " + Integer.toBinaryString(((rgb & 0x00FF0000) >> 16 )));
        int red = getRed(rgb);
